...
//                        Lật khung hình
                        ...
                        for (Rect face : facesArray) {
                            ...
                            Imgproc.putText(frame, "This is a person ", new Point(face.x, face.y - 20), 1, 2, new Scalar(255, 255, 255));
                        }
//                        Cap nhat giao dien
                        Platform.runLater(() -> {
    ...
    protected void stopCamera() {
        isCameraActive.set(false);//Dung Thread dang chay
    ...
    public void clickCapture(ActionEvent event) {
        ...
        cameraFrame.setImage(capturedImage);
